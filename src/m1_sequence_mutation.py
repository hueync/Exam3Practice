...
def run_test_zero_changer():
    ...
    # ------------------------------------------------------------------
    # Test 2:
    test2 = ([1, 3, 3, 7], [0, 0, 0, 4, 2, 0], [0, 2, 0], [5, 0, 0])
    expected2 = ([1, 3, 3, 7], [1, 2, 3, 4, 2, 4], [5, 2, 6], [5, 7, 8])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    # Test 3:
    test3 = ([0, 0, 0, 0], [5, 5, 5, 0, 0, 0], [6, 6, 6], [5, 0, 0])
    expected3 = ([1, 2, 3, 4], [5, 5, 5, 5, 6, 7], [6, 6, 6], [5, 8, 9])
    zero_changer(test3)
    print()
    print('Test 3:')
